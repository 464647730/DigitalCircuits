...
var ImageCuter = {
	cut: function(myImageData, p1, p2, p3, p4, newSize) {
		...
		for (var i = 0; i < newWidth; i++) {
			for (var j = 0; j < newHeight; j++) {
				originPosition = this.getCorrespondingOriginPosition(p1, p2, p3, p4, newWidth, newHeight, i, j);
	...
	getCorrespondingOriginPosition: function(p1, p2, p3, p4, newWidth, newHeight, x, y) {
		var A = x / newWidth, B = y / newHeight;
